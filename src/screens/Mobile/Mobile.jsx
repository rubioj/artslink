    ...
    <div className="mobile">
      <div className="mobile-home" data-palette-mode="light">
        <div className="overlap-group-6">
          ...
          />
          <img className="blue-brush" alt="Blue brush" src="/img/blue-brush-1-1.png" />
          ...
          <p className="p">Juan Rubio, San Sebastian Couple, digital photograph</p>
          <img className="couple" alt="Couple" src="/img/couple.png" />
          <p className="text-wrapper-7">Find the art work you always wanted</p>
        </div>
        <div className="overlap-3">
          <img className="brush-brown-3" alt="Brush brown" src="/img/brush-brown-1-1.png" />
        ...
        <img className="NY-city-girl" alt="Ny city girl" src="/img/ny-city-girl.png" />
        <p className="text-wrapper-9">Juan Rubio, NY City Girl, digital photograph</p>
        <AppBar
          className="app-bar-5"
          color="primary"
          to="/menu"
