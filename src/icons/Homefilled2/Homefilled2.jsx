...
export const Homefilled2 = ({ className }) => {
  return (
    ...
    >
      <g className="g" clipPath="url(#clip0_493_253)">
        <g className="g" filter="url(#filter0_d_493_253)">
      ...
      <defs className="defs">
        ...
        >
          ...
          />
          <feBlend className="fe-blend" in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_493_253" />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
        ...
        <clipPath className="clip-path" id="clip0_493_253">
