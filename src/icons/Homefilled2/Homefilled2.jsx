...
export const Homefilled2 = ({ className }) => {
  return (
    ...
    >
      <g className="g" clipPath="url(#clip0_514_190)">
        <g className="g" filter="url(#filter0_d_514_190)">
      ...
      <defs className="defs">
        ...
        >
          ...
          />
          <feBlend className="fe-blend" in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_514_190" />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_dropShadow_514_190"
            mode="normal"
            result="shape"
          />
        </filter>
        <clipPath className="clip-path" id="clip0_514_190">
