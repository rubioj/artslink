...
export const Homefilled2 = ({ className }) => {
  return (
    <svg
    ...
    >
      <g className="g" clipPath="url(#clip0_611_219)">
        <g className="g" filter="url(#filter0_d_611_219)">
      ...
      <defs className="defs">
        ...
        >
          ...
          />
          <feBlend className="fe-blend" in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_611_219" />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_dropShadow_611_219"
            mode="normal"
            result="shape"
          />
        </filter>
        <clipPath className="clip-path" id="clip0_611_219">
