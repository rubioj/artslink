...
export const Homefilled5 = ({ className }) => {
  return (
    <svg
      className={`homefilled-5 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      <g className="g" clipPath="url(#clip0_611_176)">
        <g className="g" filter="url(#filter0_d_611_176)">
      ...
      <defs className="defs">
        ...
        >
          ...
          />
          <feBlend className="fe-blend" in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_611_176" />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_dropShadow_611_176"
            mode="normal"
            result="shape"
          />
        </filter>
        <clipPath className="clip-path" id="clip0_611_176">
