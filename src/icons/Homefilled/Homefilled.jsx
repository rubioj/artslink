...
export const Homefilled = ({ className }) => {
  return (
    ...
    >
      <g className="g" clipPath="url(#clip0_522_129)">
        <g className="g" filter="url(#filter0_d_522_129)">
      ...
      <defs className="defs">
        ...
        >
          ...
          />
          <feBlend className="fe-blend" in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_522_129" />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
        ...
        <clipPath className="clip-path" id="clip0_522_129">
