...
export const Homefilled = ({ className }) => {
  return (
    <svg
    ...
    >
      <g className="g" clipPath="url(#clip0_608_106)">
        <g className="g" filter="url(#filter0_d_608_106)">
      ...
      <defs className="defs">
        ...
        >
          ...
          />
          <feBlend className="fe-blend" in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_608_106" />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_dropShadow_608_106"
            mode="normal"
            result="shape"
          />
        </filter>
        <clipPath className="clip-path" id="clip0_608_106">
