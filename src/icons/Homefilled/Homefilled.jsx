...
export const Homefilled = ({ className }) => {
  return (
    ...
    >
      <g className="g" clipPath="url(#clip0_521_133)">
        <g className="g" filter="url(#filter0_d_521_133)">
      ...
      <defs className="defs">
        ...
        >
          ...
          />
          <feBlend className="fe-blend" in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_521_133" />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
        ...
        <clipPath className="clip-path" id="clip0_521_133">
