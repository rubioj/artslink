...
export const Homefilled3 = ({ className }) => {
  return (
    ...
    >
      <g className="g" clipPath="url(#clip0_521_305)">
        <g className="g" filter="url(#filter0_d_521_305)">
      ...
      <defs className="defs">
        ...
        >
          ...
          />
          <feBlend className="fe-blend" in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_521_305" />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
        ...
        <clipPath className="clip-path" id="clip0_521_305">
